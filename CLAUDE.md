...
python3 scripts/recommend_new.py  # 弱点トピックと推奨難易度から新規問題候補を表示
```

### 新問題の日
```bash
python3 scripts/recommend_new.py          # 候補を見る（弱点トピック・難易度を自動判断）
...
- `recommend_new.py` が弱点トピックと推奨難易度から未登録の新規問題候補を表示
